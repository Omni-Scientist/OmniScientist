...
- 👁️ **2026-08-23** · **接入 DeepSeek 多模态。** `deepseek-v4-flash-vision-exp` 加入感知侧车，一个 DeepSeek key 同时管推理和看图。*([v0.1.2](https://github.com/Omni-Scientist/OmniScientist/releases/tag/v0.1.2))*
