...
- 🚀 **2026-09-02** · **v0.2.1 發布。** 全新的桌面版，歡迎使用。 *([v0.2.1](https://github.com/Omni-Scientist/OmniScientist/releases/tag/v0.2.1))*
...
- 👁️ **2026-08-23** · **DeepSeek 多模態支援。** `deepseek-v4-flash-vision-exp` 加入感知 sidecar，因此一個 DeepSeek 金鑰現在即可涵蓋推理與視覺。 *([v0.1.2](https://github.com/Omni-Scientist/OmniScientist/releases/tag/v0.1.2))*
