...
- 👁️ **2026-08-23** · **Suporte multimodal DeepSeek.** `deepseek-v4-flash-vision-exp` junta-se ao sidecar de percepção, então uma única chave DeepSeek agora cobre tanto raciocínio quanto visão. *([v0.1.2](https://github.com/Omni-Scientist/OmniScientist/releases/tag/v0.1.2))*
