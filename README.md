...
- 🚀 **2026-09-02** · **v0.2.1 released.** A brand-new desktop app. Welcome aboard. *([v0.2.1](https://github.com/Omni-Scientist/OmniScientist/releases/tag/v0.2.1))*
...
- 👁️ **2026-08-23** · **DeepSeek multimodal support.** `deepseek-v4-flash-vision-exp` joins the perception sidecar, so one DeepSeek key now covers both reasoning and vision. *([v0.1.2](https://github.com/Omni-Scientist/OmniScientist/releases/tag/v0.1.2))*
