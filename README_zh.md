...
<img src="assets/workbench.png" width="100%" alt="OmniScientist 桌面工作台，左侧对话，右侧研究记录">

桌面版运行中的界面。左侧是对话，右侧的研究记录按产出顺序收下每一张图、每一段脚本，以及最后编译出的论文。
...
工作台是一个本地网页。截图中地址栏的 `127.0.0.1` 就是全部部署。窄屏下自动收成单栏，关闭标签页即停止本轮运行。

## 溯源

<img src="assets/ui-paper-traced.png" width="100%" alt="论文视图，稿件中的数字被高亮并指回产生它的那次运行">
